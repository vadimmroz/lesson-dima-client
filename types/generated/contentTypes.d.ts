...
export interface ApiTestTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    jelloComponent: Schema.Attribute.Component<'hello.hello', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTreTre extends Struct.CollectionTypeSchema {
  collectionName: 'tres';
  info: {
    displayName: 'tre';
    pluralName: 'tres';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tre.tre'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<'plugin::google-maps.location-picker'>;
    publishedAt: Schema.Attribute.DateTime;
    qwert: Schema.Attribute.Component<'qwerty.qwerty', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
